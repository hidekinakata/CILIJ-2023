...
const Eixos: Eixo[] = [
  {
    eixo: 1,
    title: "Literatura infantil para crianças menores de seis anos",
    resume:
      "Desde o nascimento, vamos inscrevendo a criança no universo simbólico. Gestos e balbucios, inicialmente desprovidos de significados, vão, pouco a pouco, se constituindo em atividades simbólicas, a partir das interações que se estabelecem entre bebês e sujeitos mais experientes. As cantigas de ninar, parlendas, jogos de rimas são atividades que promovem essa construção de sentidos. Essa literatura de tradição oral representa uma das primeiras linguagens literárias com a qual as crianças entram em contato (Com o quê?). A medida que ampliam suas experiências com a cultura escrita, bebês e demais crianças pequenas vão podendo cada vez mais se apropriar da linguagem própria dos livros e do próprio livro como produto cultural. Considerando os bebês e as demais crianças menores de seis anos de idade, algumas questões, entre o outras, poderiam ser suscitadas: Como a literatura oral vem sendo trabalhada nas instituições de educação infantil? Que livros são adequados para crianças que ainda não leem e não escrevem convencionalmente? Quais práticas de leitura seriam adequadas a cada uma das faixas etárias que compõem a primeira infância? Como a educação infantil se relaciona com a literatura? Como deveria se relacionar? Como o mercado editorial tem se comportado em relação à produção para essa faixa etária? Como se caracteriza a literatura brasileira para bebês e crianças menores de seis anos? Que tendências podemos perceber, doravante, no processo de sua constituição?  As bibliotecas e outros espaços culturais têm se dedicado aos pequenos leitores? Quais projetos ou atividades vêm sendo desenvolvidos nesses espaços com o intuito de apoiar a formação do pequeno leitor? Vêm sendo implantadas políticas públicas que favorecem o acesso dessas crianças ao universo literário? Como elas se caracterizam? Tais questões procuram nortear e sustentar as propostas de comunicação científica de pesquisas que se debruçam sobre a problemática esboçada para o aqui delineado, Eixo ‘Literatura infantil para crianças muito pequenas’, cujas ações advogam a favor de uma Educação Literária desde a Primeira Infância.",
    presenters: [
  ...
  {
    eixo: 3,
    title: "Literatura infantil e juvenil e temas polêmicos",
    resume:
      '“Temas polêmicos”, "temas fraturantes", “temas delicados”, “temas tabu” são algumas das formas de nomear temas como: a morte, a violência, o medo, o abandono, a separação dos pais, a deficiência, a doença, a drogadição, o aborto, a sexualidade, o racismo, o preconceito, as guerras, entre outros,  quando presentes em livros literários direcionados à infância e à adolescência. Tal nomeação aponta para o desafio que tal abordagem acarreta, em função do risco do didatismo nos livros ou – em termos mais amplos – da dificuldade de aceitação de tais obras nos circuitos de leitura (quais circuitos?). Nesse sentido, o  Eixo temático pretende se abrir a discussões que problematizem os temas polêmicos, aceitando  tanto ensaios de cunho mais teórico sobre a articulação entre qualquer desses temas e a literatura infantil e juvenil, quanto análises de obras específicas (contemporâneas ou de outros momentos históricos) que os explorem – de maneira central ou secundária, por meio das personagens, por exemplo -  e, ainda, trabalhos que incorporem a análise da leitura de obra(s) que contemple(m) tais temáticas, por crianças e/ou adolescentes.',
    presenters: [
  ...
  {
    eixo: 11,
    title: "Literatura infantil e juvenil e outras áreas do conhecimento",
    resume:
      "Temas do mundo científico, como aqueles da Astronomia (Sol, Lua, estrelas, corpos celestes etc.), da Climatologia (nuvens, chuva, ventos, fenômenos da natureza etc.), da Geologia (pedras, fósseis, movimentos e processos no interior e na superfície terrestre etc.), da Biologia (animais, evolução, ciclo de vida, organismos vivos etc.) ou da Ecologia (águas, mares, florestas, humanos etc.) são cada vez mais frequentes nas obras de literatura infantil e juvenil disponíveis no mercado brasileiro. Sem se constituírem em cartilhas ou livros de atividades, paradidáticos ou enciclopédicos, estas obras trazem, com frequência, narrativas literárias com personagens ou temas de fundo nos quais estas questões são enfocadas. Assim, é fecunda a discussão sobre como estes temas são abordados em histórias publicadas para crianças, adolescentes e jovens, quer em livros ilustrados, quer em livros apenas de imagens, sem cair no didatismo ou incorporar informações cientificamente equivocadas. Nesse sentido, este Eixo focaliza as discussões dessa interrelação de linguagens e saberes em interdisciplinaridade, aceitando tanto ensaios teóricos sobre a articulação entre qualquer um desses temas e a literatura infantil e juvenil, como análises de obras específicas que os abordem (como, por exemplo: a evolução de um tema em livros de diferentes anos de publicação; a fidedignidade do conteúdo; a forma de apresentação de determinado tema; a comparação entre obras de autores estrangeiros traduzidas e as de autores nacionais; o cotejo entre obras sobre um mesmo tema; a ecocrítica nas elaborações poéticas etc.) e também trabalhos que explorem a leitura de uma ou mais obras sobre tais temáticas pela perspectiva de profissionais da educação, mediadores, contadores de histórias, crianças e/ou adolescentes.",
    presenters: [
